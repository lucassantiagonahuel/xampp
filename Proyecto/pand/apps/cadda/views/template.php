...
<?php function header($items = null){ ?>
    <nav class="mb-4 navbar navbar-dark navbar-expand-md blue darken-4" id="nav_ppal">
        <div class="container">
            <a class="navbar-brand" href="/" style="letter-spacing: 3px;"><img class="rounded-circle mr-2" src="/cadda/images/logo.png" alt=""> CADDA</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="menu_ajustes">
                            <a class="dropdown-item" href="/admin/regional/">Regional</a>
                            <a class="dropdown-item" href="/admin/usuarios/">Usuarios</a>
                            <a class="dropdown-item" href="/admin/roles/">Roles</a>
                            <a class="dropdown-item" href="/admin/roles/permisos">Permisos</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
...
<?php function footer(){ ?>
    ...
    <footer class="footer text-white mt-4 blue darken-4" id="footer_ppal">
        <div class="container">
            <div class="row">
                <div class="col-sm-9 small">Confederación Argentina de deportes acuáticos</div>
                <div class="d-none d-sm-block col-sm-3 text-right small align-self-end">©2020 Cadda</div>
            </div>
        </div>
    </footer>
<?php } ?>
