  ...
  <div id="app" class="container">
    <div class="row">
      <div class="col-lg-5 col-md-8 col-sm-7 col-xs-6">
        ...
        <button class="btn btn-info" @click="altaarticulo=true">Ingresar</button>
        <button class="btn btn-info" @click="buscararticulo=true">Buscar articulos</button>
          <div class="control" v-if="buscararticulo">
           <input type="text" class="busque" placeholder="Buscar articulos..." v-model="textoBusqueda">
           <div class="btn-group">
            <button class="btn btn-outline-primary" @click="mostrarArticulos">Buscar</button>
            <button class="btn btn-outline-danger" @click="buscararticulo=false,close">Cerrar</button>
           </div>
          </div>
        ...
        <table class="table table-bordered">
          <thead>
            ...
            <tr class="columna_nombre" v-for="(articulo,index) in articulos">
              <td>
                {{articulo.id}}
              </td>
              <td>
